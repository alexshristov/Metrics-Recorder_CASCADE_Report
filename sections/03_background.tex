...
They can be i.e. words or part of words.
Both the input as well as the output of a LLM model are represented as tokens that are concatenated to a text.
\vspace{0.25cm}
\noindent The computational cost of LLM's is closly related to the number of input and output tokens. 
Longer sequences of tokens can also influence the execution time because of the amout of computation needed.
Because of that, token usage is an important metric in any LLM usecase.
